...
<template>
  <main id="main-container pt-0 mt-o">
    <!-- Hero -->
    <div class="bg-image" style="background-image: url('/img/plugins/noghrekoob.jpeg');">
      <div class="bg-black-75">
        <div class="content content-top content-full text-center">
          <h1 class="text-white"><i class="fa fa-bowl-food"></i></h1>
          <h1 class="fw-bold text-white mt-5 mb-3"> افزونه مدیریت کارگاه ساخت نقره جات </h1>
          <h2 class="h3 fw-normal text-white-75 mb-5">مدیریت و حسابداری کارگاه ساخت نقره جات</h2>
