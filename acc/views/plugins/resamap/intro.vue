...
<template>
  <main id="main-container pt-0 mt-o">
    <!-- Hero -->
    <div class="bg-image" style="background-image: url('/img/plugins/rest.jpg');">
      <div class="bg-black-75">
        <div class="content content-top content-full text-center">
          <h1 class="text-white"><i class="fa fa-bowl-food"></i></h1>
          <h1 class="fw-bold text-white mt-5 mb-3"> افزونه مدیریت رستوران و فست‌فود </h1>
          <h2 class="h3 fw-normal text-white-75 mb-5">بهترین نرم افزار حسابداری رستوران بر بستری تا ابد رایگان</h2>
          <RouterLink to="/acc/plugin-center/view-end/restamap1">
                    ...
                    <a class="block block-bordered block-link-pop text-center mb-0" href="javascript:void(0)">
                      <div class="block-content block-content-full text-center">
                        <div class="py-2">
                          ...
                          <div class="text-primary">712</div>
                        </div>
                      </div>
                    </a>
                  </div>
                  <div class="col-sm-6 col-xl-3">
                    <RouterLink to="/acc/plugin-center/view-end/restamap1" class="block block-bordered block-link-pop text-center mb-0">
                      <div class="block-content block-content-full text-center">
                        <div class="py-2">
                    ...
                    <a class="block block-bordered block-link-pop text-center mb-0" href="javascript:void(0)">
                      <div class="block-content block-content-full text-center">
                        <div class="py-2">
                          ...
                          <div> پشتیبانی تلفنی </div>
                          <div class="text-primary">0918 328 2405</div>
